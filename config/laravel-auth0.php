...
return [
    ...
    |--------------------------------------------------------------------------
    */
    'domain' => env( 'AUTH0_DOMAIN', 'auth.marketredesign.com' ),
    ...
    |--------------------------------------------------------------------------
    */
    'client_id' => env( 'AUTH0_CLIENT_ID', 'none' ),
    ...
    |--------------------------------------------------------------------------
    */
    'client_secret' => env( 'AUTH0_CLIENT_SECRET', 'none' ),
    ...
    */
    ...
    | persist_access_token  (Boolean) Optional. Indicates if you want to persist the access token, default true
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'api_identifier' => 'https://api.pricecypher.com',
